...
import com.plh.foodappbackend.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/user/**").hasAnyRole("CUSTOMER", "RESTAURANT_OWNER", "ADMIN")
                        .requestMatchers("/api/payment/**").authenticated()
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/customer-reviews/**")
                        .permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration
                .setAllowedHeaders(Arrays.asList("Authorization", "Content-Type", "X-Requested-With", "X-Session-Id"));
